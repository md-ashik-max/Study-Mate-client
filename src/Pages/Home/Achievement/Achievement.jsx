...
const Achievement = () => {
    return (
        <div className="my-24 max-w-7xl mx-auto">
            ...
            <div className="mt-12 md:flex justify-between mx-6 space-y-6 md:space-y-0">
                <div className="flex justify-center items-center gap-6 border-2 border-[#5680E9] p-6 lg:py-12 lg:px-20 rounded-xl">
