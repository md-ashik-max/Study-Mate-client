...
const Navbar = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/submitted')
            .then(res => res.json())
            .then(data => setAllAttempted(data))
    ...
    return (
        <div className={theme==='dark'?`navbar h-32 relative z-[10] max-w-7xl mx-auto text-white`:`navbar h-32 relative z-[10] max-w-7xl mx-auto text-black`}>
                        ...
                        user ? <div className="dropdown dropdown-bottom dropdown-end dropdown-hover">
                            ...
                            <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow-xl bg-[#EDF7FA] rounded-box border-2 border-[#267188] w-52">
                                <div className="flex flex-col justify-center items-center">
                                    ...
                                    <li className="text-lg text-black font-bold mb-4">My attempt : {myAttempted.length}</li>
